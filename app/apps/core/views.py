...
from apps.utils.admin import get_admin_context
from apps.utils.logging import print_error
#

S3_STORAGE_BACKEND = settings.S3_STORAGE_BACKEND
...
def index(request):
    ...
    return render(
        request, "core/landing.html", context={"time": server_time}
    )
